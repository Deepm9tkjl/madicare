<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <html>
      ...
      <style></style><script async="" src="https://negbar.ad-blocker.org/chrome/adblocker-chromeglobalinjectjs.js"></script></head>
      <body>
       <div class="a">
          ...
          <a href="Userindex.jsp">
                <div class="card">
                  <img src="images/m14.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                  <h4><b>Thiamine HCL t.</b></h4>
                    <p>Healthcare</p> 
                  </div>
                </div>
                </a>
              ...
              <a href="Userindex.jsp">
                <div class="card1">
                  <img src="images/m15.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                    <h4><b>CELMOL-CT</b></h4> 
                    <p>Healthcare</p> 
                  </div>
          ...
          <a href="Userindex.jsp">
                <div class="card2">
                  <img src="images/m10.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                    <h4><b>THimine hcl t2</b></h4> 
                    <p>Healthcare</p> 
                  </div>
                </div>
                </a>
          ...
          <a href="Userindex.jsp">
                <div class="card3">
                  <img src="images/m11.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                    <h4><b>Molanic-cvl 625</b></h4> 
                    <p>Healthcare</p> 
                  </div>
                </div>
                </a>
          ...
          <a href="Userindex.jsp">
                <div class="card4">
                  <img src="images/m12.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                    <h4><b>Sole -40</b></h4> 
                    <p>Healthcare</p> 
                  </div>
          ...
          <a href="Userindex.jsp">
                <div class="card5 ">
                  <img src="images/m13.jpg" alt="Avatar" style="width:100%">
                  <div class="container">
                    <h4><b>DFC deflazacart t.</b></h4> 
                    <p>Healthcare</p> 
                  </div>
                </div>
                </a>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item">
                      <img class="d-block w-100" src="images/a17.jpg" alt="First slide">
                    </div>
